...
public static class ClassFactory
{
    ...
    public static void Generate()
    {
        ...
        CreateIfMissing(dir, "RenegadoDeLaCruz", "Renegado de la Cruz", ClassRole.Tank, "Espada y escudo",
            ...
            new StatBlock { maxHP = 14, defense = 3, damage = 4, attack = 70, critChance = 10, evasion = 5, apMove = 3, healingPower = 0, lifesteal = 5, threatMult = 2f },
        ...
        CreateIfMissing(dir, "SalmodianteHereje", "Salmodiante Hereje", ClassRole.Healer, "Bastón y cetro",
            ...
            new StatBlock { maxHP = 10, defense = 1, damage = 3, attack = 75, critChance = 8, evasion = 8, apMove = 3, healingPower = 100, lifesteal = 0, threatMult = 1f },
            new StatBlock { maxHP = 1, defense = 0, damage = 1, attack = 1, critChance = 0, evasion = 0, apMove = 0, healingPower = 5, lifesteal = 0, threatMult = 0f });
        ...
        CreateIfMissing(dir, "CazadorDeHalos", "Cazador de Halos", ClassRole.DPS, "Látigo",
            ...
            new StatBlock { maxHP = 1, defense = 0, damage = 1, attack = 1, critChance = 1, evasion = 0, apMove = 0, healingPower = 0, lifesteal = 1, threatMult = 0f });
