...
public static class ClassFactory
{
    ...
    public static void Generate()
    {
        ...
        CreateIfMissing(dir, "RenegadoDeLaCruz", "Renegado de la Cruz", ClassRole.Tank, "Espada y escudo",
            ...
            new StatBlock { maxHP = 2, defense = 0, damage = 1, accuracy = 1, critChance = 0, evasion = 0, apMove = 0, healingPower = 0, lifesteal = 1, threatMult = 0f });
        ...
        CreateIfMissing(dir, "CazadorDeHalos", "Cazador de Halos", ClassRole.DPS, "Látigo",
            ...
            new StatBlock { maxHP = 11, defense = 1, damage = 5, accuracy = 85, critChance = 25, evasion = 10, apMove = 4, healingPower = 0, lifesteal = 10, threatMult = 1f },
